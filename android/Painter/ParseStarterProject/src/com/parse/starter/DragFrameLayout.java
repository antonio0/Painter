 ...
 */
public class DragFrameLayout extends AbsoluteLayout {
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                if (mDragFrameLayoutController != null) {
                    ...
                    if (xvel == 0.0 && yvel == 0.0) {
                        Log.d(TAG, "CLICK");
                        Activity host = (Activity) releasedChild.getContext();
                        if (host != null) {
                            host.registerForContextMenu(releasedChild);
                            host.openContextMenu(releasedChild);
                            host.unregisterForContextMenu(releasedChild);
                        }
                        releasedChild.setClickable(false);
                        releasedChild.setLongClickable(false);
                    }
                }
            }
        });
